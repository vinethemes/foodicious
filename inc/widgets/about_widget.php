...
add_action( 'widgets_init', 'foodicious_about_load_widget' );

function foodicious_about_load_widget() {
	register_widget( 'foodicious_about_widget' );
}

class foodicious_about_widget extends WP_Widget {
    ...
    {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'foodicious_about_widget', 'description' => __('An About Me Widget', 'foodicious') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'foodicious_about_widget' );

		/* Create the widget. */
        parent::__construct(  'foodicious_about_widget', __('Foodicious: About Me', 'foodicious'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- image url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>"><?php esc_html_e( 'Image URL','foodicious' ); ?></label>
		...
		<!-- subtitle -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'subtitle' )); ?>"><?php esc_html_e( 'Sub title','foodicious' ); ?></label>
		...
		<!-- description -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'About me text','foodicious' ); ?></label>
		...
		<!-- autograph url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'signing' )); ?>"><?php esc_html_e( 'Autograph Image URL','foodicious' ); ?></label>
